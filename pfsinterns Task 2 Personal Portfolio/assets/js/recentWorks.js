const recentWorks = [
    ...
    {
        title: "MERN BLOG APP",
        description: "Blog websiter where we sharing ideas",
        techs: ["MongoDB", "Express.js", "React", "Node.js"],
        img: "/images/download.png"
    },
    {
        title: "MERN Calculator App",
        description: "Calculator App for calculation user friendly interface",
        techs: ["MongoDB", "Express.js", "React", "Node.js"],
        img: "/images/download.png"
    },
];
...
const html = recentWorks.map(work =>
    `<div class="bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <a href="https://github.com/luckymughall/pfsinterns" target="_blank"
